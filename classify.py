...
def classify_vacancy(vacancy, target_keywords, target_roles, excluded_roles):
    ...
    vacancy["matched_roles"] = find_roles(vacancy.get("title"), target_roles)
    vacancy["excluded_roles"] = find_excluded_roles(vacancy.get("title"), excluded_roles)

    return vacancy


def classify_vacancies(vacancies, target_keywords, target_roles, excluded_roles):
    return [
        classify_vacancy(vacancy, target_keywords, target_roles, excluded_roles)
